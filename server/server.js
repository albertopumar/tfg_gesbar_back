...
app.use('/api/V1/', passport.authenticate(['user', 'owner'], { session: false }), clientController);

const orderController = require("./controllers/orderController");
app.use('/api/V1/', passport.authenticate(['user', 'owner'], { session: false }), orderController);

const establishmentController = require("./controllers/establishmentController");
app.use('/api/V1/', passport.authenticate(['user', 'owner'], { session: false }), establishmentController);
